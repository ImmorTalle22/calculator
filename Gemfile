source "https://rubygems.org"                                                                                           # позволяет автоматизировать процесс управления зависимостями и обеспечивает доступность широкого спектра гемов, созданных сообществом Ruby.

ruby "2.7.7"

gem "rails", "~> 7"                                                                                                     # предоставляет множество готовых компонентов и утилит
gem "sprockets-rails"                                                                                                   # объединяет, минифицирует и компилирует статические ресурсы приложения, такие как JavaScript и CSS файлы.
gem "pg"                                                                                                                # обеспечивает поддержку работы с PostgreSQL из приложений, написанных на Ruby.
